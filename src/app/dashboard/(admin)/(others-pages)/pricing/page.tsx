...
const pricingData: OfferCardProps[] = [
  ...
  },
  {
    ...
    // infos: ["20 users included", "200 scans per month", "Phone and email support"],
    isBestValue: true,
  },
  {
    title: "Enterprise",
    ...
    infos: ["On-premise support for lifetime usage"],
  },
  {
    title: "Custom",
    ...
    infos: ["On-premise support for lifetime usage", "Microservice intergration"],
  },
];
      ...
      >
        ...
        <div className="mt-4">
          <div className="font-semibold text-4xl text-neutral-200">
            ...
            <DollarSignIcon className="inline size-5" />
          </div>
